...
# import data sets
vale1 <- getSymbols("VALE", src = "yahoo", from = "2010-01-01", to = "2020-10-31", auto.assign = FALSE)
ibov1 <- getSymbols("^BVSP", src = "yahoo", from = "2010-01-01", to = "2020-10-31", auto.assign = FALSE)
